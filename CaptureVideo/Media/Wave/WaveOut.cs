    ...
    public class WaveOut : IDisposable
    {
        ...
        */
        ...
        public int GetVolume()
        {
            ...
            {
                uint CurrVol = 0;
                WavMethods.waveOutGetVolume(m_pWavDevHandle, out CurrVol);
                ushort CalcVol = (ushort)(CurrVol & 0x0000ffff);
                value = CalcVol / (ushort.MaxValue / 16);
            }
            catch (Exception) { }
            return value;
        }
        ...
        */
        ...
        public void SetVolume(int volume)
        {
            ...
            try
            {
                int newVolume = ((ushort.MaxValue / 16) * volume);
                uint newVolumeAllChannels = (((uint)newVolume & 0x0000ffff) | ((uint)newVolume << 16));
                WavMethods.waveOutSetVolume(m_pWavDevHandle, newVolumeAllChannels);
            }
            catch (Exception) { }
        }
